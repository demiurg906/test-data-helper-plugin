...
class ChooseAdditionalFileAction(
    ...
    private val state: TestDataEditor.State
) : ComboBoxAction() {
    ...
    override fun createCustomComponent(presentation: Presentation, place: String): JComponent {
        val box = ComboBox(DefaultComboBoxModel(state.splitEditors.toTypedArray())).apply {
            item = state.splitEditors[state.currentPreview]
            addActionListener {
                state.chooseNewEditor(item)
